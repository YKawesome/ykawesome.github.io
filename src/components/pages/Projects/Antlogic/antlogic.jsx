...
function AntLogic() {
  ...
  <div className="max-w-md">
              <TypeIt className="text-6xl md:text-8xl text-neutral-content font-bold mb-20">AntLogic.</TypeIt>
              <div className="mt-6"></div>
              <TypeIt className="mt-20 text-lg md:text-xl" options={{ startDelay: 1500, speed: 40 }}>
                <span className="font-bold">AntLogic</span> is an{" "}
                <span className="italic">interactive</span>{" "}
                <span className="font-bold bg-primary text-primary-content">logic gate simulator</span>{" "}
                for <span className="font-bold bg-accent text-primary-content">education</span>,
                created at{" "}
                <span className="font-bold bg-secondary text-primary-content">IrvineHacks 2024</span>.
              </TypeIt>
              <p className="py-3 text-base md:text-lg">Developed in collaboration with:</p>
              <ul className="">
                <li>
                  Benjamin Cates{" "}
                  <a
