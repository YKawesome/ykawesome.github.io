...
function Footer({ shetr = false }) {
  ...
  const socialLinks = [
    {
      url: shetr
        ? "https://www.instagram.com/petr_the_spreadshetr?igsh=NTc4MTIwNjQ2YQ%3D%3D=="
        : "https://www.instagram.com/yak_awesome/profilecard/?igsh=MzRlODBiNWFlZA==",
      svg: (
        <svg
    ...
    {
      url: "https://www.linkedin.com/in/theyousefkhan/",
      svg: (
        <svg
          height="24"
          width="24"
    ...
    {
      url: "https://github.com/YKawesome",
      svg: (
        <svg
          width="24"
          height="24"
    ...
    <div>
      <footer className="footer sm:footer-horizontal bg-neutral text-neutral-content p-10 xl:text-lg">
        ...
        <nav>
          ...
          <br /> © 2025 {shetr ? "petr_the_spreadshetr" : "Yousef Khan"}. All
          rights reserved.
          <LinkPreview
            className="link link-secondary"
            url="https://github.com/YKawesome/ykawesome.github.io"
          >
            Source
          </LinkPreview>
        </nav>
