      ...
      <div className="hero-content text-center">
        <div className="max-w-2xl w-full">
          ...
          <form className="space-y-6">
            ...
            <div className="card bg-base-300 shadow-lg p-4">
              <h3 className="font-semibold mb-2">Mid-quarter Exams (20%)</h3>
              <div className="flex flex-col gap-2">
                <fieldset className="form-control w-full">
                  <legend className="fieldset-legend">Exam 1 Score (out of 10)</legend>
                  <input
                    type="number"
                    min="0"
                    max="10"
                ...
                <fieldset className="form-control w-full">
                  <legend className="fieldset-legend">Exam 2 Score (out of 10)</legend>
                  <input
                    type="number"
                    min="0"
                    max="10"
